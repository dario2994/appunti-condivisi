...
\begin{proof}
	...
	Se invece $d_A(x)=0$, dato che $\inf_{a\in A}d(a,x)=d_A(x)=0$, esiste una successione $(a_n)_{n\in\mathbb{N}}$ a valori in $A$ tale che $\lim_{n\to\infty}d(a_n,x)=0$, perciò $a_n\to x$. Di conseguenza $x$ appartiene ad $A$, perchè $A$ è chiuso. 
\end{proof}
...
\begin{proof}
	...
	\end{equation*}
	Quindi, dato che $\delta(K,\{x_n \})$ va a 0, anche $d(x,x_n)$ va a 0, cioè $(x_n)_{n\in\mathbb{N}}$ converge in $X$ a $x$. 
