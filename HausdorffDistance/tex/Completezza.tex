...
\begin{proof}
	...
	\end{cases} & &\end{flalign*}
	Riusciamo sempre a trovare $x_n$ come richiesto poiché la condizione $\delta(K_n,K_{n_i}) < \frac{\varepsilon}{2^i}$, sfruttando il \cref{ApprossimazioneDistanzaAsimmetrica}, ce ne assicura l'esistenza.
...
\end{equation*}
Quindi $A_{n_0}$ è limitato, ma allora lo è anche $A_1$ visto che è uguale a  $\bigcup_{n<n_0}K_n \bigcup A_{n_0}$ e unione finita di limitati è limitata. Da questo discende che $A_k$ è limitato per ogni $k$ visto che $A_k\subseteq A_1$.
