...
\begin{proof}
	...
	Unendo \cref{DeltaKR,DeltaRK} e applicando la definizione di $\delta({}\cdot{},{}\cdot{})$ otteniamo:
	\begin{equation*}
...
\end{remark}
\begin{proof}
	Essendo $\CL(X)$ un compatto è in particolare completo e totalmente limitato, perciò sono verificate le ipotesi di \cref{CompletezzaInverso,TotaleLimitatezzaInverso}. Applicando quindi tali risultati otteniamo che $X$ è completo e totalmente limitato, quindi è compatto.
\end{proof}
