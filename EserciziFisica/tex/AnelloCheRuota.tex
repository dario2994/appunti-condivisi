...
\exercise[12/12/2013]{Anello che ruota} %acr
\textex
...
\begin{itemize}
	\item 	Se $\theta_0=0$, allora $r\omega^2\left(2\cos^2\theta_0-1\right)-g\cos\theta_0=r\omega^2-g$,
			...
			\begin{equation*}
				T=\frac{2\pi}{\sqrt{\frac gr-\omega^2}}
			\end{equation*}
	...
	\item	Infine se $\cos\theta_0=\frac{g}{r\omega^2}$, si ha che
			...
			è minore di 0 se è solo se $g<r\omega^2$ e in tal caso il periodo delle piccole oscillazioni
			attorno a $\theta_0$ è:
			\begin{equation*}
				T=\frac{2\pi}{\sqrt{\left(\omega^2-\frac gr\right)\left(1+\frac g{w^2r}\right)}}
			\end{equation*}
\end{itemize}
