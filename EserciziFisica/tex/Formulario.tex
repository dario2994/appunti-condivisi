...
\begin{equation*}
	...
	m_a\left(\vec\omega\vec r^2_\alpha-\vec r_\alpha\left(\vec\omega\cdot\vec r_\alpha\right)\right)
	\end{split}
\end{equation*}
...
\begin{equation*}
	...
	\omega_j m_\alpha\left(\delta_{ij}\omega_j\vec r^2_\alpha-r_{\alpha i}\omega_j r_{\alpha j}\right)
\end{equation*}
