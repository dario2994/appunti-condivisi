...
\begin{split}
	\overrightarrow{v}	& =\dot{\overrightarrow{r}}=\dot{r}\hat{r}+r\overrightarrow{w}\times\hat{r}\\
						& =\dot{r}\hat{r}+r\dot{\theta}\hat{z}\times\hat{r}\\
						& =\dot{r}\hat{r}+r\dot{\theta}\hat{\theta}
\end{split}
\end{equation}
\begin{equation}\label{AccCooPolari}
\begin{split}
	\overrightarrow{a}	& =\dot{\overrightarrow{v}}=\ddot{r}\hat{r}+\dot{r}\dot{\theta}\hat{\theta}+\dot{r}\dot{\theta}\hat{\theta}+r\ddot{\theta}\hat{\theta}+r\dot{\theta}\hat{\theta} \\
						& =\dot{r}\hat{r}+r\dot{\theta}\hat{z}\times\hat{r}\\
						& =\dot{r}\hat{r}+r\dot{\theta}\hat{\theta}
\end{split}
\end{equation}
