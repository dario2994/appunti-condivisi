...
\begin{proof}
	Possiamo supporre $M=\R^n$ e $\Delta_0=span\{\DerParz{}{t^1}(0),\ldots,\DerParz{}{t^k}(0)\}$. Sia $\pi:\R^n\to\R^k$ la proiezione sulle prime $k$ coordinate. Allora $\T\pi\restrict{\Delta_0}:\Delta_0\to \T_0\R^k\cong \R^k$ è un isomorfismo.
