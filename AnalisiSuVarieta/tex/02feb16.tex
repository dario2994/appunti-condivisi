...
\begin{example}
	\begin{enumerate}
		...
		\end{align*} %TODO: mi sono un po' persa
		...
		%TODO: Finora ha scambiato covarianti e controvarianti
...
\begin{proposition}
	...
	\begin{equation*} %TODO: non ho scritto tutte le seguenti formule
...
\begin{exercise}
	\begin{enumerate}
		...
		\item Sia $\dim(V) = n$ e $\dim(V) = m$. Dimostrare che $T_s^r(V,W)$ ha dimensione $(mn)^{r+s}$. %TODO: controllare se è giusto
	\end{enumerate}
\end{exercise}
