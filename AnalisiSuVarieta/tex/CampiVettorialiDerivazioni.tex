...
\begin{theorem}[Cauchy-Lipschitz]  \index{Cauchy-Lipschitz}
...
\begin{proposition}[Esistenza e unicità di flussi locali] \index{teorema!esistenza e unicità di flussi locali}
...
\begin{definition} \index{campo vettoriale!flusso generato}
