...
\begin{proposition} \label{prop:CondizioneIntegrabilitaDistribuzioniDaGeneratori} %TODO: magari dare un label sensato
...
\begin{theorem}[Frobenius] \index{teorema!Frobenius}
...
\begin{proof} %TODO: decidere se usare T o \T per il tangente
	...
	Quindi per la \cref{prop:ParentesiZeroImplicaCoordinateLocali} possiamo scegliere $X_1,\ldots,X_k\in\Delta$ (vicino a 0) tali che $(\T\pi)X_i(q) = \DerParz{}{t^i}\restrict{\pi(q)}$ per $i=1,\ldots, k$.
