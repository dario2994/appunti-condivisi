...
\begin{definition}
	Definiamo la derivata di Lie in $p$ di $Y$ rispetto a $X$ come \begin{equation*}(\Lie_X(Y))(p)=\lim_{h\to 0}\frac{Y(p)-((\Fl{X}{h})_*Y)(p)}h \punto
	\end{equation*}
\end{definition}
...
\begin{proof}
	\begin{description}
	 ...
	 &=\lim_{h\to 0}\frac 1h \left\{f(p)[Y(p)-(\Fl{X}{h})_*(Y(\Fl{X}{-h}(p)))]+[f(p)-f(\Fl{X}{-h}(p))](\Fl{X}{h})_*(Y(\Fl{X}{-h}(p))\right\}\\
...
\begin{proof}
	Definiamo $\alpha_1(t,h)=\Fl{Y}{t}\Fl{X}{h}(p)$, $\alpha_2(t,h)=\Fl{X}{-t}\Fl{Y}{h}\Fl{X}{h}$, $\alpha_3(t,h)=\Fl{Y}{-t}\Fl{X}{-h}\Fl{Y}{h}\Fl{X}{h}$. Notiamo innanzitutto che $c(t)\alpha_3(t,t)$, $\alpha_2(0,t)=\alpha_1(t,t)$ e $\alpha_3(0,t)=\alpha_2(t,t)$.
