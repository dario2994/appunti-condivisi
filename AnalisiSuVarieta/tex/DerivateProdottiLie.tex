...
\begin{equation*}
	X(f)(p)=\lim_{h\to 0} \frac 1h \left[ f(F_X(p,h))-f(p) \right] %TODO: qui c'era (X(p))f(p)
\end{equation*}
...
\begin{remark}
	...
	\begin{enumerate} %TODO: mettere il pull-back o i segni meno
...
\begin{proof} %TODO: ho messo un - push-forward, che potrebbe anche essere un pull-back: decidere cos'è meglio
