...
\begin{proof} %TODO: capire anche qui
...
\begin{proof}
	...
	\begin{equation*}
		\frac{\de}{\de t}(\Fl{X}{t})_*Y=\frac{\de}{\de s}(\Fl{X}{t+s})_*Y\restrict{s=0}=(\Fl{X}{t})_*\comm{X}{Y}=0\punto %TODO: prima la cosa centrale era \frac{\de}{\de s}\Fl{X}{t+s}Y
	\end{equation*}
...
\begin{proof}
	...
	\begin{equation*} %TODO: sistemare
		\DerParz{f\circ\alpha_1}{t}=(Yf)\circ\alpha_1 \virgola
		\DerParz{f\circ \alpha_2}{t} = -(Xf)\circ \alpha_2 \virgola
		\DerParz{f\circ\alpha_3}{t}=-(Yf)\circ\alpha_3 \virgola
		\DerParz{f\circ\alpha_1}{h}(0,h)=(Xf)(\alpha_1(0,h))
	\end{equation*}
...
\begin{theorem}
	Se $c(t)$ è come nella \cref{prop:DefinizioneDerSeconda}, $c''(0)=2\comm{X}{Y}(p)$.
\end{theorem}
