...
\begin{theorem} \label{thm:ProprietaProdottoInterno}
	...
	\begin{enumerate}
		...
		\item $\Lie_X \alpha = i_X \de\alpha + \de( i_X\alpha)$ \emph{(formula di Cartan)}; \label{ppi:DeForma}\index{formula di Cartan} %TODO: sarebbe bello linkare a lei direttamente, magari dargli la dignità di teorema
