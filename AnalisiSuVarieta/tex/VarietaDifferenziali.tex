...
\begin{example} \index{grassmanniana} %TODO: cambiare notazione \pi_G(H,F) -> \pi_G(F)\restrict H?
 ...
 \begin{remark}
  ...
  \begin{enumerate}
   ...
   \item le varietà sono spazi topologici normali; %TODO: aggiungere definizione?
