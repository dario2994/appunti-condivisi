...
\begin{definition} \index{prodotto!interno}
	...
	\begin{equation*}
		i^\beta t(\beta^1,\ldots,\beta^{r-1},v_1,\ldots,v_s) = t(\beta,\beta^1,\ldots,\beta^{r-1},v_1,\ldots,v_s)\punto
	\end{equation*}
\end{definition}
...
\begin{remark}
	$T_0^1(\varphi) = \varphi_*$, ma $T_0^1(V)\cong V$, $T_0^1(W)\cong W$, allora $T_0^1(\varphi) \in \Lin(V,W)$ ed è proprio $\varphi$.
\end{remark}
...
\begin{proof}
	Il fatto che $\varphi_*$ sia un isomorfismo sulle fibre segue dalla \cref{prop:ProprietaPushForward}.
