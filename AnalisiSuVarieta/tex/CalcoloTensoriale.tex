...
\end{exercise}
\begin{exercise}
	Siano $V,W$ due spazi vettoriali con $\dim(V) = n$ e $\dim(W) = m$. Dimostrare che $T_s^r(V,W)$ ha dimensione $n^{r+s}m$. %TODO: controllare che la dimesione sia giusta
\end{exercise}
...
\begin{remark}
Si verifica che $\varphi_*$ è continua. %TODO: non capisco il senso di dire che \phi è continua, dato che è lineare tra spazi finito-dimensionali; forse si intendeva dire che la definizione data è effettivamente quella di una mappa lineare?
\end{remark}
