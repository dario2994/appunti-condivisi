...
Sia quindi $\psi=(y^1,\ldots, y^n): U \to \R^n$ un altro sistema di coordinate e supponiamo $\DerParz{}{x^i} = a_i^j \DerParz{}{y^j}$. Applichiamo il campo vettoriale alla funzione coordinata $y^k$, per ottenere $\DerParz{y^k}{x^i} = a_i^j \DerParz{y^k}{y^j} = a_i^j \delta_j^k = a_i^k$ e quindi $\DerParz{}{x^i} = \DerParz{y^j}{x^i} \DerParz{}{y^j}$.
