...
\begin{proof}
	...
	Sia $\pi_1:G\times H \to G$ la proiezione e $\omega = \pi_1\restrict K$.
...
\end{corollary}
\begin{proof}
	Dato $\Phi: \mathfrak g \to \mathfrak h$ isomorfismo, sia $\phi$ la mappa data dal teorema. %TODO: aggiungere cref
...
\begin{corollary}
	Per ogni $X \in T_eG$, esiste unico un sottogruppo ad un parametro $\phi: \R \to G$ tale che $\frac{\de\phi}{\de t}\restrict{t=0} = X$.
\end{corollary}
\begin{proof}
	Sia $f:G\to \R$ e sia $\phi: \R \to G$ un omomorfismo $C^\infty$ tale che $\frac{\de\phi}{\de t}\restrict{t=0} = X$. Abbiamo che
	\begin{align*}
	...
	\end{align*}
	Quindi se esiste un tale omomorfismo $\phi$, deve essere una curva integrale di $\tilde X$ (estensione di $X$ a $G$).
...
\begin{remark}
	Le curve integrali esistono localmente, ma usando le proprietà di gruppo  si può mostrare esistenza globale.
\end{remark}
...
\begin{proof}
	...
	Quindi $(\exp_*)_0 (v) = \frac{\de \exp(c(t))}{\de t}\restrict {t=0} = \frac{\de}{\de t} \restrict {t=0} \exp(tu)$, perciò $(\exp_*)_0$ è l'identità e di conseguenza $\exp$ è un diffeomorfismo in un intorno di $0\in T_eG$.
...
Perciò $\div(e)(X,Y) = -\omega(e)(\comm XY)$. %TODO: \label *
