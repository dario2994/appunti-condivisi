...
\begin{definition} \index{operatore!differenziale} \label{def:OperatoreDifferenziale}
	...
	\begin{enumerate}
	 \item $\mathcal D$ sia una derivazione tensoriale, cioè commuta con le contrazioni. \label{od:Derivazione} %[$\mathcal D_1$)] 
...
Vediamo ora le formule in coordinate, cioè, dato $t\in\Tau_s^r(M)$, vogliamo le componenti di $\Lie_Xt$.
