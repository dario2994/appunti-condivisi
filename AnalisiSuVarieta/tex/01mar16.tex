...
\begin{proof}
	\begin{description}
		...
		quindi esiste $a\in\R$ tale che $*\beta = a e^{\sigma(1)} \wedge\ldots\wedge e^{\sigma(n)}$, per cui $\beta\wedge * \beta = a\ \sgn(\sigma) \mu$ e la proposizione precedente implica $\Scal \beta\beta=1$.
...
\begin{proof}
	...
	\end{align*}
	Dove nell'equazione precedente sto sommando su $j=1, \ldots,n$ e $\sigma \in S_n$ tale che $\sigma(j)< \sigma(i_1)< \dots < \sigma(i_k)$.
