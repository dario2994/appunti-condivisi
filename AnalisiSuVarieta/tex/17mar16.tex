...
\begin{definition} \index{varietà!con bordo!parte interna} \index{varietà!con bordo!bordo}
...
\begin{proof}
	Abbiamo che
	\begin{equation*}
		(\div X) \mu = \Lie_X \mu = \de (i_X \mu) + i_X \de \mu = \de (i_X \mu) %TODO: perché?
	\end{equation*}
...
\begin{theorem} [Formula di coarea] \label{thm:FormulaCoarea} 
