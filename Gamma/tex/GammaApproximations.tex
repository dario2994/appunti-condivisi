...
\begin{proof}
	...
	\end{split}
	\end{equation*}
	Ora definisco per comodità $h(x,s)=\frac{\sqrt{2x}}{s}-\frac{x}{s^2}\ln\left(1+s\sqrt{\frac{2}{x}}\right)$ 
	...
	$-\infty<a<b<\infty$. Ciò equivale a dimostrare che $h(x,s)\to 1$ uniformemente su $[a,b]$ per $x\to\infty$.
