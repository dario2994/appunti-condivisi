...
\begin{proof}
	...
	aperto; quindi consideriamo un sottoricoprimento finito $U_1, \dots, U_n$. Il \cref{thm:PartizioneUnita} fornisce quindi delle funzioni
	$f_x$ per ogni $x\in\{0,\dots, n\}$. Definiamo quindi $\psi_0:U_0\rightarrow \R$ tale che $\psi_0(x)=1$ se $x\notin \Omega$, $\psi_0(x)=-1$
	altrimenti. Sia ora 
	\[
