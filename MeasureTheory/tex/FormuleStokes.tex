...
\begin{proof}
	...
	$V\times \oo{a}{b} \supseteq U_p$ in modo che $u(x)=0$ per ogni $x\in \partial V\times \oo{a}{b}$. Allora, per il teorema di Fubini e il
	...
	\]
	Quindi abbiamo la tesi del primo punto quando $p\in\Omega$.
\end{proof}
