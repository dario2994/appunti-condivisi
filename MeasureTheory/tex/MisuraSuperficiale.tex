...
\begin{proof}
	...
	\end{equation*}
	e analogamente $\sigma'(E)=\sum_{i,j\in\N} \sigma_i'(E\cap B_{i,j})$. In queste sommatorie a due indici non mi devo preoccupare dell'ordine in cui faccio le somme, perchè tutti i termini della sommatoria sono positivi (poichè integrali di funzioni positive).
