...
\begin{remark}\label{nota:BorelianiSottovarieta}
	Utilizzando la stessa notazione del \cref{lemma:SottovarietaUnioneNumerabile}, notiamo che $\Sigma_i$ è un Boreliano di $\R^n$ per ogni $i\in\N$ e quindi anche $\Sigma=\cup_{i\in\N}\Sigma_i$ è un Boreliano, poichè unione di Boreliani. (AGGIUNGERE CHE IMMAGINE DI APERTI TRAMITE CONTINUE È BORELIANA)  
	Di conseguenza abbiamo che i Boreliani di $\Sigma$ sono un sottoinsieme dei Boreliani di $\R^n$, in quanto corrispondono alla \sigalg\ generata dagli aperti di $\Sigma$, che però sono Boreliani di $\R^n$, in quanto intersezione fra aperti di $\R^n$ e $\Sigma$ che è Boreliano.
\end{remark}
