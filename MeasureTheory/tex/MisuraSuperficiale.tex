...
Vogliamo ora dimostrare che quella appena data è una buona definizione, cioè tutte le quantità sono ben definite, la definizione non dipende dalla scelta di $\{\Sigma_i\}_{i\in\N}$ e dalle parametrizzazioni e che quella definita è veramente una misura.
...
\begin{remark}\label{nota:DefMisuraKDimBuona}
