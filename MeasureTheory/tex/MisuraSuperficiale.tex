...
\begin{exercise}
	Calcolare il volume di un tetraedro $n$-dimensinoale di lato 1\footnote{Per tetraedro $n$-dimensionale di lato $d$ definiamo l'inviluppo convesso di $n+1$ punti in $\R^n$ a distanza $d$ uno dall'altro.}.
\end{exercise}
\begin{proof}
