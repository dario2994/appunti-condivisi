...
\begin{definition}
	Una funzione $f:X \rightarrow \Rbar$ con dominio lo spazio di misura $(X,\A,\mu)$ si dice semplice se è combinazione lineare di
...
\begin{proof}
	...
	nel primo caso abbiamo che $|f(x)-\phi_n(x)|\leq \frac{1}{2^n}$ definitivamente, cioè $\forall n\geq |f(x)|$,
	nel secondo caso $\phi_n(x)=\pm n\rightarrow \pm\infty = f(x)$;
