...
\begin{proof}
	...
	\[
		\{fg>a\}=\left\{\begin{array}{ll}
			X\in \A &\quad \text{se $a<0$}\puntovirgola\\
			\{f>0\}\cup\{g>0\}\in \A &\quad \text{se $a=0$}\puntovirgola\\
			\bigcup_{q\in \Q^+}\left(\{q<f<+\infty\}\cap\left\{\frac{a}{q}<g<+\infty \right\} \right)\in \A &\quad \text{se $0<a<+\infty$}\puntovirgola\\
			(\{f=+\infty\}\cap\{g>0\})\cup (\{f>0\}\cap\{g=+\infty\})\in \A &\quad \text{se $a=+\infty$}\punto
		\end{array}\right.
	\]
	\end{description}
\end{proof}
