...
\begin{remark}
	Se esistono funzioni misurabili $f:X\rightarrow \Rbar$, con $(X,\A,\mu)$ spazio di misura, allora $X\in\A$. Infatti deve valere $X=f^{-1}(\Rbar)\in\A$, perchè $\Rbar$ è un aperto.
\end{remark}
...
\begin{proof}
	...
	\end{array}\right.
	\end{equation*}
	Quindi, per la \ref{BM:sov} della \cref{BasicMis}, $f^+$ è misurabile. Analogamente si dimostra che $f^-$ è misurabile.
\end{proof}
