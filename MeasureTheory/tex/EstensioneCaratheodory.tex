...
\begin{theorem}\label{thm:EquivalenzeMisurabilitaSottoinsieme}
	Dato $(X,\S,\mu)$ una spazio di misura elementare, sia $\mu^*$ la misura esterna associata a $\mu$ (come definita nell'enunciato di \cref{prop:MisuraEsternaDiPremisura}) e $\A$ la \sigalg{} di Caratheodory (la cui esistenza mi è assicurata dal \cref{thm:EstensioneCaratheodory}) con la relativa estensione della misura $\mu':\A\to\Rpiu$.
...
\begin{proposition}\label{prop:CaratheodoryCompletamentoSigAlg}
	Dato $(X,\S,\mu)$ una spazio di misura elementare \sigfin[o], i relativi misurabili secondo Caratheodory coincidono con il completamento (rispetto alla misura che ci è assicurata da \cref{thm:EstensioneCaratheodory}) della \sigalg{} generata da $\S$.
\end{proposition}
\begin{proof}
