...
\begin{proposition}\label{thm:EquivalenzeMisurabilitaSottoinsieme}
...
\begin{proof}
	...
	Notiamo che nella dimostrazione di \ImplicationProof{UnioniDaFuoriEquivalenze}{SigmaDaFuoriEquivalenze} del \cref{thm:EquivalenzeMisurabilitaSottoinsieme} scriviamo $B$, che è per l'appunto un insieme che coincide con $A$ a meno di un sottoinsieme trascurabile, come intersezione numerabile di $(S_n)_{n\in\N}\subseteq \sqcup \S$.
