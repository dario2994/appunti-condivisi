...
\end{theorem}
\begin{proof}
	La dimostrazione procede in tre passi: prima mostriamo che $\mathcal A$ è un'algebra di insiemi, poi che è è una \sigalg{} e infine che $\mu$ è \sigadd{} e completa ridotta su $\mathcal A$.
	...
	Infine per dimostrare la completezza di $\mu|_{\mathcal A}$ basta mostrare che dato $E\in\mathcal P(X)$ trascurabile, vale $E\in\mathcal A$ (questo è sufficiente a mostrare la completezza, visto che per monotonia i sottinsiemi di un trascurabile sono a loro volta trascurabili).
	...
	\end{equation*}
	che è proprio la condizione di appartenenza ad $\mathcal A$.
\end{proof}
...
\begin{theorem}[Estensione di Caratheodory]\label{EstensionexCaratheodory}
	Dato $(X,\mathcal S,\mu)$ uno spazio di misura elementare esiste una \sigalg{} $\mathcal A$ e una funzione $\mu':\mathcal A\to\Rpiu$ tali che $\mathcal S\subseteq \mathcal A$, $\mu'$ estende la premisura $\mu$ e $(X,\mathcal A,\mu')$ è uno spazio di misura completo.
\end{theorem}
\begin{proof}
	...
	Possiamo ora ridurre $\mu^*$ grazie al \cref{RiduzionePreCaratheodory} ad una misura completa $\mu':\mathcal A\to\Rpiu$ dove $\mathcal A$ è la \sigalg{} di Caratheodory. 
