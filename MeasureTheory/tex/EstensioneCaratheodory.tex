...
\begin{proof}
	...
	Essendo una misura, $\mu'$ è \sigsubadd{} e monotona per le \cref{nota:SubAdditivitaMisura,nota:MonotoniaMisura}, e di conseguenza vale
	\begin{equation*}
...
\begin{proof}
	...
	\begin{description}
		\item[\ImplicationProof{it:MisurabileEquivalenze}{it:UnioniDaFuoriEquivalenze}] Definiamo $A_n=A\cap X_n$. Gli $A_n$ sono misurabili, perché intersezioni di misurabili, e hanno misura finita dato che la misura è monotona.
