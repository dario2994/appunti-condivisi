...
\begin{proposition}\label{prop:TrascurabiliProdotto} %TODO: Sarebbe da aggiustare la dimostrazione, togliendo gli integrali.
...
\begin{proof}
	...
	Ma poichè questo è valido per ogni $A$ aperto di $\R$ ne concludiamo che $\hat f$ è misurabile nel prodotto.
\end{proof}
