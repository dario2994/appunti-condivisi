...
\begin{proof}
	...
	\begin{align*}
		...
		=\int_X\int_Y f(x,y)\de\nu(y)\de\mu(x)\virgola
	\end{align*}
	dove abbiamo implicitamente sfruttato che, come osservato nel MISREF, il fatto che la somma di funzioni integrabili sia definita solo quasi ovunque non influisce sul valore dell'integrale doppio.
\end{proof}
...
\end{theorem}
\begin{proof}
	Si dimostra identicamente a come si è dimostrato \cref{thm:Fubini}, solo che, al posto di applicare \cref{thm:Tonelli}, si applica \cref{thm:TonelliCompleto}.
\end{proof}
