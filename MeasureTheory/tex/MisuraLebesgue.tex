...
\begin{proof}
	...
	Grazie alla \cref{nota:ParteInternaAllargamento} abbiamo che la successione composta dalle parti interne degli elementi della successione $\left(F_{\frac\epsilon{2^i}}(S_i)\right)_{i\in\N}$ è un ricoprimento aperto di $S$ e quindi, per quanto detto, della chiusura di $S'$ che è compatta essendo chiusa e limitata. 
	Perciò, per compattezza, esiste un insieme finito di indici $I\subseteq \N$ tale che $\left(F_{\frac\epsilon{2^i}}(S_i)\right)_{i\in I}$ è un ricoprimento finito di $S'$.
