...
\begin{proof}
	...
	\]
	Inoltre, dato che $C$ è chiuso e limitato, $H^\mathsf{c}$ è chiuso e $C \cap H^\mathsf{c} = \emptyset$, esiste $\rho>0$ tale che
