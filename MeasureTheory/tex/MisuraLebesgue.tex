...
\begin{corollary}\label{cor:MisurabiliNonParti}
	Grazie al \cref{InsiemeVitali}, è ovvio mostrare che i misurabili di $\R^n$ non coincidono con le parti di $\R^n$.
\end{corollary}
