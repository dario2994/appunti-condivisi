...
% SPOSTARE QUI I FATTI SU LINDELOF

\begin{corollary}\label{cor:LocLipschitzTengonoMisurabili}
	Data una funzione $f:E\subseteq \R^n\to\R^n$ localmente Lipschitziana, per ogni $A\subseteq E$ misurabile anche l'immagine $f(A)$ è misurabile.
\end{corollary}
\begin{proof}
	Poichè $\R^n$ ammette una base numerabile, anche $E$ la ammette e di conseguenza il sottospazio topologico $E$ risulta avere la proprietà di Lindelöf.
	...
	Da un tale ricoprimento, per la proprietà di Lindelöf, estraiamo un ricoprimento numerabile $(A_n)_{n\in\N}\subseteq E$ tale che, per ogni $n\in\N$, la funzione $f$ ridotta su $A_n$ è Lipschitziana.
