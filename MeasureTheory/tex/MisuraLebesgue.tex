...
\begin{proposition}\label{prop:LipschitzTengonoMisurabili}
	...
	\begin{equation*}
		\forall A\in\M_n:\ \lambda^n m_n(A) \ge m_n(f(A)) \punto
	\end{equation*}
\end{proposition}
\begin{proof}
...
\begin{proof}
	...
	Dato $\epsilon>0$ e $k\in\N$, poniamo
	\begin{equation*}
		I_\epsilon(k)=\co{-k}k\times\co{-k}k\times\cdots\times \co{\frac{-\epsilon}{(2k)^{n-1}2^{k+1}}}{\frac{+\epsilon}{(2k)^{n-1}2^{k+1}}}\punto
	\end{equation*}
