...
\begin{lemma}\label{lemma:lem:SemianelloSemiAperti}
...
\begin{lemma}\label{lemma:lem:LebesgueElementareFinita}
...
\end{theorem}
\begin{proof}
	Per quanto mostrato nel \cref{lemma:lem:SemianelloSemiAperti} la famiglia $\S_n$ è un \semiring{}.
	...
	Applicando il \cref{lemma:lem:LebesgueElementareFinita} abbiamo facilmente
	\begin{equation*}
	...
	Sfruttando ancora il \cref{lemma:lem:LebesgueElementareFinita} e applicando la \cref{prop:MisuraAllargamento} otteniamo
	\begin{equation*}
...
\begin{proof}
	...
	Per ottenere che si può scrivere $A$ come unione disgiunta è sufficiente applicare la \cref{prop:UnioneDisgiuntaQuasiAlgebra} ricordando che $\S_n$ è un \semiring{} come dimostrato nel \cref{lemma:lem:SemianelloSemiAperti}.
\end{proof}
...
\end{proposition}
\begin{proof}
	Il \cref{thm:EstensioneCaratheodory} ci assicura che la \sigalg{} $\M_n$ dei Boreliani contiene la \sigalg{} generata da $\S_n$ e perciò, sfruttando \cref{prop:SigAlgUgualeBoreliani}, otteniamo i Boreliani sono misurabili secondo Lebesgue come voluto.
