...
\begin{proof}
	...
	Per \cref{LimSemCrescMis}, per ogni $n$ esiste una successione crescente di funzioni semplici positive $(\simp_{n,k})$ che converge puntalmente a $f_n$. In particolare utilizzando la stessa costruzione di \cref{LimSemCrescMis} notiamo che è possibile scegliere le $\simp_{n,k}$ crescenti anche rispetto a $n$. Allora la successione $(\simp_{n,n})$ converge puntalmente a $f$. Di conseguenza otteniamo proprio
	\begin{equation*}
...
\begin{lemma}[Fatou]
	...
	\begin{equation*}
		\int_X\left(\liminf_{n\to\infty}f_n\right)\de\mu\le \liminf_{n\to\infty}\int_Xf_n\de\mu
	\end{equation*}
\end{lemma}

\begin{proof}
	Applichiamo il \cref{BeppoLevi} alle funzioni alla successione crescente $(\inf_{k\ge n}f_n)$ che converge puntalmente alla funzione $\liminf_{n\to\infty}f_n$ e otteniamo
	\begin{equation*}
		\int_X\left(\liminf_{n\to\infty}f_n\right)\de\mu=\int_X \sup_{n\in\N}\left\{\inf_{k\ge n}f_n\right\}\de\mu=\sup_{n\in\N}\int_X \inf_{k\ge n}f_n\de\mu\le \liminf_{n\to\infty}\int_Xf_n\de\mu
	\end{equation*}
\end{proof}
...
\begin{proposition}
	...
	\begin{enumerate}
		\item $\int (af+bg)\de\mu=a\int f\de\mu+b\int g\de\mu$;
		\item $f\le g\Longrightarrow \int f\de\mu\le \int g\de\mu$.
	\end{enumerate}
\end{proposition}
\begin{proof}
	TODO
