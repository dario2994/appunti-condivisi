...
\begin{proposition}[Derivata sotto il segno d'integrale] \label{prop:CommutazioneDerivataIntegrale}%TODO: Forse si può togliere l'ipotesi di C^1... o forse si può togliere qualche altra ipotesi.
