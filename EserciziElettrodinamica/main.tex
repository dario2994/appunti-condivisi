...
\usepackage[a4paper,twoside,top=0.7in, bottom=1in, left=0.7in, right=0.7in]{geometry} %top,bottom,left,right are margins
\usepackage{graphicx}
...
\usepackage{xparse} %In order to use ExplSyntax (in old latex)
...
\title{Eserciziario di Elettrodinamica}
